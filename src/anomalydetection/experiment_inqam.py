...
def experiment_inqameasurement(X, y, setting, mlflow, best=False):
    ...
    with mlflow.start_run(run_name=setting["z_run_name"]):
        ...
        model = inqameasurement.InqaMeasurement(X_memory.shape[1], dim_x=setting["z_rff_components"],
                gamma=setting["z_gamma"], random_state=setting["z_random_state"], 
                batch_size=setting["z_batch_size"], window_size=setting["z_window_size"])
